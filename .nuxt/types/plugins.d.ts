...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/@pinia/colada-nuxt/dist/runtime/payload-plugin.js")> &
  ...
  InjectionType<typeof import("../../node_modules/@pinia/colada-nuxt/dist/runtime/plugin.js")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'vue-devtools-client' | 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'session-fetch-plugin' | 'nuxt:browser-devtools-timing' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | '@nuxt/icon' | 'Pinia Colada' | 'nuxt:checkIfLayoutUsed'
  }
}
