declare global {
  const AppliedDatabaseMigrationsQuery: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').AppliedDatabaseMigrationsQuery
  const CreateDatabaseMigrationsTableQuery: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').CreateDatabaseMigrationsTableQuery
  ...
  const applyDatabaseMigrations: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/migrations').applyDatabaseMigrations
  const applyDatabaseQueries: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/migrations').applyDatabaseQueries
  const applyRemoteDatabaseMigrations: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/remote').applyRemoteDatabaseMigrations
  const applyRemoteDatabaseQueries: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/remote').applyRemoteDatabaseQueries
  ...
  const copyDatabaseMigrationsToHubDir: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').copyDatabaseMigrationsToHubDir
  const copyDatabaseQueriesToHubDir: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').copyDatabaseQueriesToHubDir
  ...
  const desc: typeof import('../../server/utils/db').desc
  const dynamicEventHandler: typeof import('../../node_modules/h3').dynamicEventHandler
  const eq: typeof import('../../server/utils/db').eq
  const eventHandler: typeof import('../../node_modules/h3').eventHandler
  const fetchRemoteDatabaseMigrations: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/remote').fetchRemoteDatabaseMigrations
  ...
  const getDatabaseMigrationFiles: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').getDatabaseMigrationFiles
  const getDatabaseQueryFiles: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').getDatabaseQueryFiles
  ...
  const queryRemoteDatabase: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/remote').queryRemoteDatabase
  ...
  const splitSqlQueries: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').splitSqlQueries
  ...
  const useDatabaseMigrationsStorage: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').useDatabaseMigrationsStorage
  const useDatabaseQueriesStorage: typeof import('../../node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers').useDatabaseQueriesStorage
...
declare global {
  ...
  // @ts-ignore
  export type { Habit, User } from '../../server/utils/db'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/satyendrak/Downloads/habit/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/satyendrak/Downloads/habit/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { hubHooks, onHubReady } from '/Users/satyendrak/Downloads/habit/node_modules/@nuxthub/core/dist/runtime/base/server/utils/hooks';
export { hubDatabase, proxyHubDatabase } from '/Users/satyendrak/Downloads/habit/node_modules/@nuxthub/core/dist/runtime/database/server/utils/database';
export { defineOAuthAppleEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/apple';
export { defineOAuthAtlassianEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/atlassian';
export { defineOAuthAuth0EventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/auth0';
export { defineOAuthAuthentikEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/authentik';
export { defineOAuthAzureB2CEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/azureb2c';
export { defineOAuthBattledotnetEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/battledotnet';
export { defineOAuthCognitoEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/cognito';
export { defineOAuthDiscordEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/discord';
export { defineOAuthDropboxEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/dropbox';
export { defineOAuthFacebookEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/facebook';
export { defineOAuthGiteaEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/gitea';
export { defineOAuthGitHubEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/github';
export { defineOAuthGitLabEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/gitlab';
export { defineOAuthGoogleEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/google';
export { defineOAuthHerokuEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/heroku';
export { defineOAuthHubspotEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/hubspot';
export { defineOAuthInstagramEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/instagram';
export { defineOAuthKeycloakEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/keycloak';
export { defineOAuthKickEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/kick';
export { defineOAuthLineEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/line';
export { defineOAuthLinearEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/linear';
export { defineOAuthLinkedInEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/linkedin';
export { defineOAuthLiveChatEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/livechat';
export { defineOAuthMicrosoftEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/microsoft';
export { defineOAuthOktaEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/okta';
export { defineOAuthOryEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/ory';
export { defineOAuthPaypalEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/paypal';
export { defineOAuthPolarEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/polar';
export { defineOAuthRobloxEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/roblox';
export { defineOAuthSalesforceEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/salesforce';
export { defineOAuthSeznamEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/seznam';
export { defineOAuthSlackEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/slack';
export { defineOAuthSpotifyEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/spotify';
export { defineOAuthSteamEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/steam';
export { defineOAuthStravaEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/strava';
export { defineOAuthTikTokEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/tiktok';
export { defineOAuthTwitchEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/twitch';
export { defineOAuthVKEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/vk';
export { defineOAuthWorkOSEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/workos';
export { defineOAuthXEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/x';
export { defineOAuthXSUAAEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/xsuaa';
export { defineOAuthYandexEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/yandex';
export { defineOAuthZitadelEventHandler } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/zitadel';
export { getAtprotoClientMetadata } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/utils/atproto';
export { hashPassword, verifyPassword } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/utils/password';
export { sessionHooks, getUserSession, setUserSession, replaceUserSession, clearUserSession, requireUserSession } from '/Users/satyendrak/Downloads/habit/node_modules/nuxt-auth-utils/dist/runtime/server/utils/session';
export { tables, useDB, sql, eq, and, or, desc } from '/Users/satyendrak/Downloads/habit/server/utils/db';
export { useDatabaseMigrationsStorage, getDatabaseMigrationFiles, copyDatabaseMigrationsToHubDir, CreateDatabaseMigrationsTableQuery, AppliedDatabaseMigrationsQuery, useDatabaseQueriesStorage, getDatabaseQueryFiles, copyDatabaseQueriesToHubDir, splitSqlQueries } from '/Users/satyendrak/Downloads/habit/node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/helpers';
export { applyDatabaseMigrations, applyDatabaseQueries } from '/Users/satyendrak/Downloads/habit/node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/migrations';
export { queryRemoteDatabase, fetchRemoteDatabaseMigrations, applyRemoteDatabaseMigrations, applyRemoteDatabaseQueries } from '/Users/satyendrak/Downloads/habit/node_modules/@nuxthub/core/dist/runtime/database/server/utils/migrations/remote';