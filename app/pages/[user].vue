    ...
    <div class="relative z-10">
      ...
      <template v-else>
        <div class="scrollable-card max-h-[calc(100vh-18.875rem)] overflow-y-auto">
          ...
          <!-- Observer Section -->
          <div v-if="observedHabits.length > 0" class="mt-8 px-4">
             <h3 class="mb-4 text-lg font-semibold text-white/50">Observing</h3>
             <div v-for="item in observedHabits" :key="item.share.id" class="mb-4">
